...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
    &nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Label ID="Label1" runat="server" ForeColor="Black" Text="Id Habitación"></asp:Label>
&nbsp;
    <asp:TextBox ID="txt_IdHabitacion" runat="server" TabIndex="1"></asp:TextBox>
    <br />
    &nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Label ID="Label2" runat="server" ForeColor="Black" Text="Tipo de Habitación"></asp:Label>
&nbsp;
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:BookingHoteleraConnectionString1 %>" SelectCommand="SELECT [DescripcionTipoHabitacion] FROM [Tipo_Habitaciones]"></asp:SqlDataSource>
    <br />
    &nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Label ID="Label3" runat="server" ForeColor="Black" Text="Descripción de la Habitacón"></asp:Label>
&nbsp;
