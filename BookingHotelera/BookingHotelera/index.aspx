			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="align-items-center justify-content-start">
						...
						<!--trabajar en borrar el div de arriba -->
						<!--bucador -->
					...
					<div class="footer_nav_container d-flex flex-row align-items-center justify-content-lg-end">
						<div class="footer_nav">
							<ul class="footer_nav_list">
								...
								<li class="footer_nav_item"><a href="offers.apsx">offers</a></li>
								<li class="footer_nav_item"><a href="blog.aspx">news</a></li>
								<li class="footer_nav_item"><a href="contact.aspx">contact</a></li>
							</ul>
						</div>
					</div>
				</div>
